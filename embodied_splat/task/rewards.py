...
from embodied_splat.measurements.collision_penalty import CollisionPenalty
from embodied_splat.measurements.imagenav import AngleSuccess, AngleToGoal
...
@registry.register_measure
class ImageNavRewardCollisionPenalty(Measure):
    cls_uuid: str = "imagenav_reward_collision_penalty"
        ...
        **kwargs: Any,
        ...
        task.measurements.check_measure_dependencies(
            ...
            [
                ...
                AngleToGoal.cls_uuid,
                AngleSuccess.cls_uuid,
                CollisionPenalty.cls_uuid,
            ],
        )
        self._metric = None
        self._previous_dtg = None
        self._previous_atg = None
        self._previous_collision_penalty = None
        self.update_metric(task=task)
    ...
    def update_metric(self, *args: Any, task: EmbodiedTask, **kwargs: Any):
        ...
        # collision penalty
        collision_penalty = task.measurements.measures[
            CollisionPenalty.cls_uuid
        ].get_metric()
        # reward
        self._metric = (
