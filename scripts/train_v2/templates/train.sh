...
if [[ "${SCENE_NAME}" == "null" && "${MESH_TYPE}" == "null" ]]; then  
  TENSORBOARD_DIR="tb/${TASK}/${MAIN_DATASET}/ddppo_imagenav/vc1/exp_inr_collision/steps_1000/seed_100/300_m"
  CHECKPOINT_DIR="data/new_checkpoints_v2/${TASK}/${MAIN_DATASET}/ddppo_imagenav/vc1/exp_inr_collision/steps_1000/seed_100/300_m"
else
  TENSORBOARD_DIR="tb/${TASK}/${MAIN_DATASET}/${MESH_TYPE}/${SCENE_NAME}/ddppo_imagenav/vc1/exp_inr_collision/steps_1000/seed_100/300_m"
