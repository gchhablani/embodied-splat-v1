...
if [[ "${SCENE_NAME}" == "null" && "${MESH_TYPE}" == "null" ]]; then  
  TENSORBOARD_DIR="tb/finetune_hssd_ckpt_332/${TASK}/${MAIN_DATASET}/ddppo_imagenav/vc1/exp_inr_collision/steps_1000/seed_100/20_m"
  ...
  TENSORBOARD_DIR="tb/finetune_hssd_ckpt_332/${TASK}/${MAIN_DATASET}/${MESH_TYPE}/${SCENE_NAME}/ddppo_imagenav/vc1/exp_inr_collision/steps_1000/seed_100/20_m"
