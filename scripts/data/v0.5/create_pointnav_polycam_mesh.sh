#!/bin/bash
#SBATCH --job-name=create_pointnav_polycam_mesh
...
srun python -u mesh_nav/utils/create_pointnav_stretch.py \
    ...
    --episode_data_path "./data/datasets/pointnav/pointnav_polycam_mesh/v0.5" \
    --scene_files_path "./data/scene_datasets/polycam_data/polycam_mesh" \
