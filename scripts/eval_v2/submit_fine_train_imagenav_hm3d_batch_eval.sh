...
SCENE="grad_lounge"
MESH_TYPE="polcam_mesh"
ckpt_dir="data/new_checkpoints_v2/finetune_hm3d_ckpt_204/imagenav/polycam_data/polycam_mesh/grad_lounge/ddppo_imagenav/vc1/exp_inr_collision/steps_1000/seed_100/20_m"
...
do
    ...
    CHECKPOINT_ID=${i}
    TENSORBOARD_DIR="tb/${TASK}/${MAIN_DATASET}/ddppo_imagenav/vc1/exp_inr_collision/steps_1000/seed_100/20_m/eval_ckpt_fine_tune_grad_lounge_${CHECKPOINT_ID}"
    ...
    # use this job name directly and modify
    updated_job_name=fine_train_cross_eval_v2/v0.8/imagenav/${SCENE}_on_${MAIN_DATASET}/individual_${i}/${MESH_TYPE}/${SCENE}/ddppo_imagenav/vc1/exp_inr_collision/steps_1000/seed_100
