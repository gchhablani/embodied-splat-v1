#!/bin/bash
#SBATCH --job-name=cross_evals_v2/hssd_on_mesh/v0.5/${TASK}/${MAIN_DATASET}/${MESH_TYPE}/${SCENE_NAME}/ddppo_imagenav/vc1/exp_inr_collision/steps_1000/seed_100
...
CHECKPOINT_DIR="data/new_checkpoints_v2/imagenav/hssd-hab/ddppo_imagenav_high_lr/vc1/exp_inr_collision/steps_1000/seed_100/1200_m/ckpt.332.pth"
if [[ "${SCENE_NAME}" == "null" && "${MESH_TYPE}" == "null" ]]; then  
  TENSORBOARD_DIR="tb/${TASK}/${MAIN_DATASET}/ddppo_imagenav/vc1/exp_inr_collision/steps_1000/seed_100/300_m/cross_fixed_eval_hssd_ckpt_332"
else
  TENSORBOARD_DIR="tb/${TASK}/${MAIN_DATASET}/${MESH_TYPE}/${SCENE_NAME}/ddppo_imagenav/vc1/exp_inr_collision/steps_1000/seed_100/300_m/cross_fixed_eval_hssd_ckpt_332"
fi
