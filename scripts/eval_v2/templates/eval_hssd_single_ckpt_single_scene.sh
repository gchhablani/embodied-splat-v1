#!/bin/bash
#SBATCH --job-name=eval_v2/v0.5/${TASK}/${MAIN_DATASET}/individual_${CKPT_ID}/${SCENE}/${MESH_TYPE}/${SCENE_NAME}/ddppo_imagenav/vc1/exp_inr_collision/steps_1000/seed_100
