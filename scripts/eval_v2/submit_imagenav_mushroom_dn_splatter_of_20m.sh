...
TASK="imagenav"
MAIN_DATASET="mushroom"
DATA_PATH="data/datasets/pointnav/pointnav_mushroom_dn_splatter/v0.5"
CONFIG_FILE="config/experiments/ddppo_${TASK}_inr_collision_v2.yaml"

MESH_TYPES=("dn_splatter")
SCENE_NAMES=("sauna" "honka" "activity")
...
SBATCH_SCRIPT_PATH="./scripts/eval_v2/templates/eval_of_20m.sh"
