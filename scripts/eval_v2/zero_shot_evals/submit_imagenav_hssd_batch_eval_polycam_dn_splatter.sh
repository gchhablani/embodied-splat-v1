...
do
    ...
    CHECKPOINT_ID=${i}
    TENSORBOARD_DIR="tb/${TASK}/${MAIN_DATASET}/ddppo_imagenav_high_lr/vc1/exp_inr_collision/steps_1000/seed_100/1200_m/dn_splatter/ablation_eval_ckpt_${CHECKPOINT_ID}"
