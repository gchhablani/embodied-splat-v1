#!/bin/bash
#SBATCH --job-name=fine_train_eval_hm3d_v3/v0.5/${TASK}/${MAIN_DATASET}/${MESH_TYPE}/${SCENE_NAME}/ddppo_imagenav/vc1/exp_inr_collision/steps_1000/seed_100
...
if [[ "${SCENE_NAME}" == "null" && "${MESH_TYPE}" == "null" ]]; then  
  TENSORBOARD_DIR="tb/finetune_hm3d_ckpt_204_on_hm3d/${TASK}/${MAIN_DATASET}/ddppo_imagenav/vc1/exp_inr_collision/steps_1000/seed_100/20_m/eval"
  CHECKPOINT_DIR="data/new_checkpoints_v2/finetune_hm3d_ckpt_204/${TASK}/${MAIN_DATASET}/ddppo_imagenav/vc1/exp_inr_collision/steps_1000/seed_100/20_m"
else
  TENSORBOARD_DIR="tb/finetune_hm3d_ckpt_204_on_hm3d/${TASK}/${MAIN_DATASET}/${MESH_TYPE}/${SCENE_NAME}/ddppo_imagenav/vc1/exp_inr_collision/steps_1000/seed_100/20_m/eval"
  CHECKPOINT_DIR="data/new_checkpoints_v2/finetune_hm3d_ckpt_204/${TASK}/${MAIN_DATASET}/${MESH_TYPE}/${SCENE_NAME}/ddppo_imagenav/vc1/exp_inr_collision/steps_1000/seed_100/20_m"
fi
